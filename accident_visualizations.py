...
def accident_severity_month(df):
    ...
    # Set colors
    color_map = {
        "Fatal or Serious": "darkred",
        "Minor": "lightgreen",
        "Property Damage Only": "steelblue",
        "Below Reporting Threshold": "lightgrey"
    }
...
def generate_accident_severity_bar_chart(df):
    ...
    gravities = ["Fatal or Serious", "Minor", "Property Damage Only", "Below Reporting Threshold"]
